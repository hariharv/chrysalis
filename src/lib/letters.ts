...
<body>
  <div class="card">
    ...
    <p id="waiting">This letter is still becoming. Keep it somewhere safe, and come back when
    its day arrives.</p>
    <blockquote id="letter" class="hidden">${escapeHtml(letter.body)}</blockquote>
    <p class="note">This file is the letter itself — it needs no website, no account, no
    company to survive. The gentle lock below is a promise, not a prison: the words are inside
    this file, waiting for you to keep the promise.</p>
  </div>
  <script>
...
export const PAST_LETTERS: PastLetter[] = [
  {
    ...
    body: "My darling girl — you are four years old today and you fell asleep holding my thumb.\n\nBy the time you read this I will be a photograph to you, and that is all right. I wanted you to have one thing from me that wasn't secondhand: I have loved my ordinary life. The kettle, the chalk dust, your grandfather humming off-key. If your day is ordinary too, do not let anyone tell you it is small.\n\nWear something blue. It was my mother's trick and it never failed.\n\n— Your Nana",
  },
  {
    id: "1999-david",
